...
from core.gen_models import (
	LocalModel, OpenAIModel, OpenAIChatModel, AzureOpenAIChatModel, GPT35Turbo0613ChatModel, GPT4Turbo20240409ChatModel, DeepSeekChatModel
)
...
if __name__ == "__main__":
	...
	parser.add_argument('--output', type=str, default="C:\\Users\\Windows11\\Desktop\\GDPZero-master\\outputs\\gdpzero_noopenloop_10sims_5dialogs.pkl", help='output file')
	parser.add_argument('--llm', type=str, default="gpt-3.5-turbo", choices=["code-davinci-002", "gpt-3.5-turbo", "chatgpt", "gpt-3.5-turbo-0613", "gpt-4-turbo-2024-04-09", "deepseek-chat"], help='OpenAI model name')
